...
mean_prcp_change_percent <- 1 + parse.param("precip_mean_y1")/100
# mean_prcp_change_percent <- 1 + as.numeric(args[3])/100
var_prcp_change_percent <- 1 + parse.param("precip_var_y1")/100
# var_prcp_change_percent <- 1 + as.numeric(args[4])/100
mean_temp_change_celsius <- parse.param("temp_mean_y1")
# mean_temp_change_celsius <- as.numeric(args[5])
metdata <- paste0(args$data_dir,"/climate_data/east") 
