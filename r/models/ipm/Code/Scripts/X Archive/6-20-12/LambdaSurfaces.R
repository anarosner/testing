    ...
    for (temppert in 1:(length(tvariables))){
     temp <- tvariables[temppert]
       for (flowpert in 1:(length(fvariables))){
         ...
         cat(pertriver,firstSeason,flowpert,temppert)
      }
    }
  } 
}
...
persp(tvariables,fvariables,perturblambdas[1,1,,], theta=60, zlim=c(.90,.98), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 1 Season 1");
persp(tvariables,fvariables,perturblambdas[1,2,,], theta=60, zlim=c(.93,.97), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 1 Season 2");
persp(tvariables,fvariables,perturblambdas[1,3,,], theta=60, zlim=c(.93,1.01), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 1 Season 3"); 
persp(tvariables,fvariables,perturblambdas[1,4,,], theta=60, zlim=c(.90,.97), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 1 Season 4"); 


win.graph(); par(mfrow=c(2,2));
persp(tvariables,fvariables,perturblambdas[2,1,,], theta=60, zlim=c(.94,.96), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 2 Season 1");
persp(tvariables,fvariables,perturblambdas[2,2,,], theta=60, zlim=c(.94,.97), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 2 Season 2");
persp(tvariables,fvariables,perturblambdas[2,3,,], theta=60, zlim=c(.94,.97), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 2 Season 3"); 
persp(tvariables,fvariables,perturblambdas[2,4,,], theta=60, zlim=c(.93,.97), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 2 Season 4"); 


win.graph(); par(mfrow=c(2,2));
persp(tvariables,fvariables,perturblambdas[3,1,,], theta=60, zlim=c(.80,1.01), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 3 Season 1");
persp(tvariables,fvariables,perturblambdas[3,2,,], theta=60, zlim=c(.80,1.2), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 3 Season 2");
persp(tvariables,fvariables,perturblambdas[3,3,,], theta=60, zlim=c(.82,1.1), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 3 Season 3"); 
persp(tvariables,fvariables,perturblambdas[3,4,,], theta=60, zlim=c(.75,.99), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 3 Season 4");

win.graph(); par(mfrow=c(2,2));
persp(tvariables,fvariables,perturblambdas[4,1,,], theta=60, zlim=c(.945,.95), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 4 Season 1");
persp(tvariables,fvariables,perturblambdas[4,2,,], theta=60, zlim=c(.94,1.1), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 4 Season 2");
persp(tvariables,fvariables,perturblambdas[4,3,,], theta=60, zlim=c(.945,.95), ticktype ="detailed",
      xlab=" Seasonal Temperature", ylab=" Seasonal Flow",zlab="Lambda");title("River 4 Season 3"); 
persp(tvariables,fvariables,perturblambdas[4,4,,], theta=60, zlim=c(.945,.95), ticktype ="detailed",
