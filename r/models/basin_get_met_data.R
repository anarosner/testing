...
if(length(which(temp.points==1)) > 0) {
	...
	if(length(met.list) == 1) {
		...
		setwd(basin.dir) #Set this to the directory where data needs to get written for climate data
